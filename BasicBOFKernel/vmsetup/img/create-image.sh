...
# create a default user called basicBOF
echo "basicBOF::1000:1000:basicBOF:/home/basicBOF:/bin/bash" | sudo tee -a $DIR/etc/passwd
echo "basicBOF:x:1000:" | sudo tee -a $DIR/etc/group
sudo mkdir -p $DIR/home/basicBOF/.ssh
cat $RELEASE.id_rsa.pub | sudo tee $DIR/home/basicBOF/.ssh/authorized_keys
sudo chown -R 1000:1000 $DIR/home/basicBOF
...
sudo cp ../../message.ko $DIR/root/message.ko
echo "@reboot root insmod /root/message.ko && chmod 777 /dev/messager; chmod 700 /root/flag.txt; chmod 777 /proc/kallsyms" | sudo tee -a $DIR/etc/crontab
...
# sudo cp ../poc/poc $DIR/home/basicBOF/poc
